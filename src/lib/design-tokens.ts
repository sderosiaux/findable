/**
 * Design Tokens for Findable AI SEO Platform
 * Professional, minimalist design system inspired by Apple/Stripe/Linear
 */
...
export const colors = {
  ...
  // Neutral Scale (optimized for both light and dark modes)
  gray: {
    25: '#fcfcfd',
    50: '#f9fafb',
    100: '#f2f4f7',
